...
<div align="center">
  <img src="https://github.com/user-attachments/assets/fe483332-f249-406a-a849-cb694a7c4d55" alt="3D 프린터 완성품 사진 1" width="400">
  <img src="https://github.com/user-attachments/assets/95c2282f-d2ef-41c2-a2b0-59c948922026" alt="3D 프린터 완성품 사진 2" width="400">
</div>

### 🎬 프린터 동작 및 출력 데모

<div align="center">
  <img src="https://github.com/user-attachments/assets/320dcbbf-8b21-4be0-ac9a-d248d5ec650b" alt="프린터 동작 데모" width="800">
</div>
...
<div align="center">
  <img src="https://github.com/user-attachments/assets/60c27aff-8800-4dc0-b3f3-eab6ce08d27e" alt="정기구학 다이어그램" width="600">
</div>
...
* **단위 벡터 $n_{unit}$:**
    $$n_{unit} = \left(\frac{y_1 - y_2}{d}, \frac{x_1 - x_2}{d}\right)$$
* **법선 벡터의 크기 $|n|$:**
    $$|n| = \sqrt{{L_2}^2 - \left(\frac{d}{2}\right)^2}$$
* **최종 벡터 $n$:**
    $$n = \sqrt{{L_2}^2 - \left(\frac{d}{2}\right)^2} \times \left(\frac{y_1 - y_2}{d}, \frac{x_1 - x_2}{d}\right)$$
...
<div align="center">
  <img src="https://github.com/user-attachments/assets/9bf52db3-ac38-4127-88c3-4f40e751b8fd" alt="역기구학 다이어그램" width="600">
</div>
...
$$\cos\alpha = \frac{a^2 + offset^2 - b^2}{2a \times offset} \Rightarrow \alpha = \cos^{-1}\left(\frac{a^2 + offset^2 - b^2}{2a \times offset}\right)$$
$$\cos\gamma = \frac{b^2 + offset^2 - a^2}{2b \times offset} \Rightarrow \gamma = \cos^{-1}\left(\frac{b^2 + offset^2 - a^2}{2b \times offset}\right)$$

**2.3 2번 삼각형의 각 변의 길이인 $L_1, L_2, a$와 제2코사인법칙을 이용하여 $\beta$ 구하기**
$$\cos\beta = \frac{{L_1}^2 + a^2 - {L_2}^2}{2aL_1} \Rightarrow \beta = \cos^{-1}\left(\frac{{L_1}^2 + a^2 - {L_2}^2}{2aL_1}\right)$$

**2.4 3번 삼각형의 각 변의 길이인 $L_1, L_2, b$와 제2코사인법칙을 이용하여 $\delta$ 구하기**
$$\cos\delta = \frac{{L_1}^2 + b^2 - {L_2}^2}{2bL_1} \Rightarrow \delta = \cos^{-1}\left(\frac{{L_1}^2 + b^2 - {L_2}^2}{2bL_1}\right)$$
...
<div align="center">
  <img src="https://github.com/user-attachments/assets/2bcf953b-4bce-4120-9e74-171f93867b4d" alt="기구학 검증 및 작업 공간 시뮬레이션" width="600">
