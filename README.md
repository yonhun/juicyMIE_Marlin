...
> 거리 $d = \sqrt{(x_2 - x_1)^2 + (y_2 - y_1)^2}$
> 
> 단위 벡터 $n_{unit} = \left(\frac{y_1 - y_2}{d}, \frac{x_1 - x_2}{d}\right)$
> 
> 법선 벡터의 크기 $|n| = \sqrt{{L_2}^2 - \left(\frac{d}{2}\right)^2}$
> 
> 최종 벡터 $n = \sqrt{{L_2}^2 - \left(\frac{d}{2}\right)^2} \times \left(\frac{y_1 - y_2}{d}, \frac{x_1 - x_2}{d}\right)$
